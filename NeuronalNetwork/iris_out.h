...
void display_result_neuronne (DataNeuronne *dataNeuronne){
    ...
    printf("\033[22;31mIris-setosa:     1\n");
	printf("\033[22;32mIris-versicolor: 2\n");
	printf("\033[22;34mIris-virginica:  3\n");
    printf("\033[22;33mIris-New:        4\n\n");
    int value;
    for(int i=0; i< size.vertical; i++){
         for(int j=0; j< size.horizontal; j++){
...
void freeSpace (DataIris* data, DataNeuronne* dataNeuronne, double* average){
